...
?>
				<tr class="row<?php echo $k; ?> ui-state-default" id="option_li_<?php echo $row->id; ?>">
					...
					<td valign="middle" align="left" style="vertical-align: middle;padding-left: 22px;">
						<a href="admin.php?page=cfg_forms&act=edit&id=<?php echo $row->id;?>"><?php echo $row->name; ?></a>
					</td>
					<td valign="top" align="left" style="vertical-align: middle;">
						<a target="_blank" href="admin.php?page=cfg_fields&filter_form=<?php echo $row->id;?>">Manage Fields (Total: <?php echo $row->num_fields; ?>)</a>
					</td>
					<td valign="middle" align="left" style="vertical-align: middle;">
						<input class="wpcfg_shortcode" value='[contactformgenerator id=&quot;<?php echo $row->id;?>&quot;]' onclick="this.select()" readonly="readonly" />
					</td>
					<td valign="middle" align="left" style="vertical-align: middle;">
						<a target="_blank"  href="admin.php?page=cfg_templates&act=edit&id=<?php echo $row->template_id;?>"><?php echo $row->template_title; ?></a>
					</td>
					<td valign="middle" align="center" style="vertical-align: middle;">
						<?php echo $row->id; ?>
					</td>
